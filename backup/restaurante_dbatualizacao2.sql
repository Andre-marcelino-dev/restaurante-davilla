...
INSERT INTO horarios (dia, horario, created_at, updated_at)
VALUES
('Mon - Fri', '09:00 - 22:00', NOW(), NOW()),
('Sat', '11:00 - 00:00', NOW(), NOW()),
('Sunday', 'Holiday', NOW(), NOW());

describe horarios;

ALTER TABLE horarios
ADD dia VARCHAR(100),
ADD horario VARCHAR(100);
...
select * from categorias_cardapio;

DELETE FROM categorias_cardapio WHERE id_categoria IN (6, 7);

ALTER TABLE categorias_cardapio ADD COLUMN status_categoria VARCHAR(20) DEFAULT 'ATIVO';
