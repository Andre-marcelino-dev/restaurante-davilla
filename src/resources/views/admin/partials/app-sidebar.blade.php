<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    ...
    <div class="sidebar-brand">
        <a href="{{ route('admin.dash') }}" class="brand-link">
            ...
            <span class="brand-text fw-light">Restaurante-Davilla Admin</span>
        </a>
    </div>
            ...
            <ul
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.conteudo.banner') }}" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Banners</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.funcionarios') }}" class="nav-link">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Funcionários</p>
                            </a>
                        </li>
