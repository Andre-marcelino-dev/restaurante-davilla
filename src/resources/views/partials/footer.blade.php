  <!-- rts footer area start -->
    ...
    <div class="rts-footer-one rts-section-gap2Top">
        <div class="shape-1"><img src="{{asset('restaurante/images/footer/vector5.webp')}}" alt="shape"></div>
        <div class="shape-2"><img src="{{asset('restaurante/images/footer/vector6.webp')}}" alt="shape"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="main-footer-wrapper-one">
                        <div class="single-footer-wized-one logo-area" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                            <a href="index.html" class="logo">
                                <img src="{{asset('restaurante/images/logo/01.svg')}}" alt="logo">
                            </a>
                            <p class="disc-f">
                        ...
                        <div class="single-footer-wized-one gallery" data-sal="slide-up" data-sal-delay="550" data-sal-duration="800">
                            <div class="gallery-item"><img src="{{asset('restaurante/images/gallery/sm-01.jpg')}}" alt=""></div>
                            <div class="gallery-item"><img src="{{asset('restaurante/images/gallery/sm-02.jpg')}}" alt=""></div>
                            <div class="gallery-item"><img src="{{asset('restaurante/images/gallery/sm-03.jpg')}}" alt=""></div>
                            <div class="gallery-item"><img src="{{asset('restaurante/images/gallery/sm-04.jpg')}}" alt=""></div>
                            <div class="gallery-item"><img src="{{asset('restaurante/images/gallery/sm-05.jpg')}}" alt=""></div>
                            <div class="gallery-item"><img src="{{asset('restaurante/images/gallery/sm-06.jpg')}}" alt=""></div>
                        </div>
                    </div>
