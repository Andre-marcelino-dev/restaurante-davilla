   <!-- header style two -->
    <!-- header area start -->
    <header class="header-two header-five header--sticky">
                    ...
                    <div class="header-main-wrapper">
                                        ...
                                        <li class="has-droupdown mega">
                                            ...
                                            <div class="submenu menu-home">
                                                <ul class="container flex-mega">
                                                    <li><a href="menu.html"><img src="{{asset('restaurante/images/project/menu-1.webp')}}" alt="menu"> <br> MenuTab</a></li>
                                                    <li><a href="menu-list.html"><img src="{{asset('restaurante/images/project/menu-2.webp')}}" alt="menu"><br>MenuList</a></li>
                                                    <li><a href="menu-list2.html"><img src="{{asset('restaurante/images/project/menu-3.webp')}}" alt="menu"><br>MenuList2</a></li>
                                                    <li><a href="menu-section.html"><img src="{{asset('restaurante/images/project/menu-4.webp')}}" alt="menu"><br>MenuSection</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li class="has-droupdown pages">
                        ...
                        <div class="logo-area">
                            <a href="index.html" class="logo">
                                <img src="{{asset('restaurante/images/logo/01.svg')}}" alt="image-logo">
                            </a>
                        </div>
                        <!-- header right start -->
                        <div class="rts-header-right">
                            <div class="button-area-banner">
                                <a href="reservation.html" class="rts-btn btn-secondary">RESERVATION</a>
                            </div>
