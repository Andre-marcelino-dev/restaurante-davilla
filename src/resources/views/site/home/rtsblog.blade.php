            ...
            <div class="row text-center">
                <div class="col-lg-12">
                    <div class="banner-one-wrapper">
                        ...
                        <p class="desc" data-sal="slide-up" data-sal-delay="700" data-sal-duration="800">It’s the story of an everlasting love affair, Dieter Delicioz and the <br> Atlantic Ocean in the big air.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper mySwiper-blog">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog-wrapper">
                                <div class="image-part">
                                    <img src="{{asset('restaurante/images/blog/blog-01.jpg')}}" alt="blog">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-wrapper">
                                <div class="image-part">
                                    <img src="{{asset('restaurante/images/blog/blog-03.jpg')}}" alt="blog">
                                </div>
                                <div class="blog-badge">
                                    <span class="date">12</span>
                                    <span class="month">APR</span>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-wrapper">
                                <div class="image-part">
                                    <img src="{{asset('restaurante/images/blog/blog-04.jpg')}}" alt="blog">
                                </div>
                                <div class="blog-badge">
                                    <span class="date">12</span>
                                    <span class="month">APR</span>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-wrapper">
                                <div class="image-part">
                                    <img src="{{asset('restaurante/images/blog/blog-02.jpg')}}" alt="blog">
                                </div>
                                <div class="blog-badge">
                                    <span class="date">12</span>
                                    <span class="month">APR</span>
