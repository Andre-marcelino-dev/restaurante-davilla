            ...
            <div class="about-area-inner">
                <div class="image-section">
                    <div class="reveal-item overflow-hidden aos-init">
                        ...
                        <img src="{{ asset('restaurante/images/gallery/gallery-img-04.jpg') }}" alt="image">
                    </div>
                    <span class="round-shape"><img src="{{ asset('restaurante/images/menu/round.png') }}"alt="about"></span>
                </div>
                <div class="content">
