                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="service-wrapper" data-sal="slide-up" data-sal-delay="120" data-sal-duration="800">
                            <div class="icon">
                                <img src="{{ asset('restaurante/images/gallery/icon.png') }}" alt="icon">
                            </div>
                            <div class="content">
                                <h2 class="title">
                    ...
                    <div class="col-lg-4">
                        <div class="service-wrapper" data-sal="slide-up" data-sal-delay="200" data-sal-duration="800">
                            <div class="icon">
                                <img src="{{ asset('restaurante/images/service/icon/02.png') }}" alt="icon">
                            </div>
                            <div class="content">
                                <h2 class="title">
                    ...
                    <div class="col-lg-4">
                        <div class="service-wrapper" data-sal="slide-up" data-sal-delay="250" data-sal-duration="800">
                            <div class="icon">
                                <img src="{{ asset('restaurante/images/service/icon/03.png') }}" alt="icon">
                            </div>
                            <div class="content">
                                <h2 class="title">
